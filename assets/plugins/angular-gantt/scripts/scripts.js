    ...
    .controller('MainCtrl', ['$scope', '$timeout', '$log', 'ganttUtils', 'GanttObjectModel', 'Sample', 'ganttMouseOffset', 'ganttDebounce', 'moment', function($scope, $timeout, $log, utils, ObjectModel, Sample, mouseOffset, debounce, moment) {
        ...
        $scope.options = {
            ...
            dateFrames: {
                ...
                '15-April': {
                    evaluator: function(date) {
                        return date.month() === 4 && date.date() === 15;
                    },
                    targets: ['holiday']
                },
                '5-May': {
                    evaluator: function(date) {
                        return date.month() === 28 && date.date() === 5;
                    },
                    targets: ['holiday']
                },
                '3-July': {
                    evaluator: function(date) {
                        return date.month() === 7 && date.date() === 3;
                    },
                    targets: ['holiday']
                },
                '3-September': {
                    evaluator: function(date) {
                        return date.month() === 9 && date.date() === 3;
                    },
                    targets: ['holiday']
                },
                '22-November': {
                    evaluator: function(date) {
                        return date.month() === 11 && date.date() === 22;
                    },
                    targets: ['holiday']
                },
                '24-December': {
                    evaluator: function(date) {
                        return date.month() === 12 && date.date() === 24;
                    },
                    targets: ['holiday']
                },
                '30-December': {
                    evaluator: function(date) {
                        return date.month() === 13 && date.date() === 30;
                    },
                    targets: ['holiday']
                }*/
            },
