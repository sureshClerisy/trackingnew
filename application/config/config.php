...
$config['limit_per_page'] = 10;
$config['limit_per_page_load'] = 100;


//Navixy credentials
$config['proxy_ips'] 	= '';
$config['login'] 		= 'vika@lodgeos.com';
$config['password'] 	= 'vika@123';
$config['navixy_auth_url'] 	= 'https://api.navixy.com/v2/user/auth';
$config['navixy_api_url'] 	= 'https://api.navixy.com/v2/';

//Truck Stop credentials:
$config['truck_username'] 	= 'VIKALOGSTWS';
$config['truck_password'] 	= 'b3Qp23Ng';
$config['truck_accountId'] 	= 'T291457VL';
$config['truck_id'] 		= '271425';
...
$config['triumph_user']     = 'karina@vikalogisticscorp.com';
$config['triumph_pass']     = 'vikadoral2017';
$config['triumph_apik']     = '93c202de-7c63-45aa-bbf2-d73750ba7518';
$config['triumph_url']      = 'https://api.mytriumph.com/v1/login';
$config['triumph_url_request']      = 'https://api.mytriumph.com/';
