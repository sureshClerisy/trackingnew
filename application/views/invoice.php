						...
						<tr>
							<td style="width:40%">
								...
								<address  style="font-style: normal; font-family: arial; font-weight: normal; float: left; margin-top: 0px;">
									<?php echo $jobRecord["postingAddress"]; ?>
									<br> <?php echo $jobRecord["city"].', '.$jobRecord["state"].', '.$jobRecord["zipcode"]; ?>
								</address>
							</td>
							<td style="width:20%">
								&nbsp;&nbsp;
							...
							<td style="width:40%">
								...
								<table>
									<tbody>
										...
										<tr>
											<td><b>Ship Date</b></td>
											<td style="text-align:right;"><?php echo (isset($jobRecord['PickupDate']) && $jobRecord['PickupDate'] != '' && $jobRecord['PickupDate'] != '0000-00-00') ? $jobRecord['PickupDate'] : ''; ?></td>
										</tr>
										<tr>
                        ...
                        <tbody>
                            <tr>
                                <td class="">
									...
									<?php 
										$pickupAddress = trim($jobRecord['PickupAddress']).', '.$jobRecord['OriginCity'].', '. $jobRecord['OriginState'].', '.$jobRecord['OriginCountry']; 
										$pickupAddress = trim($pickupAddress,',');
									?>
									<p class="small hint-text"><b>Address:</b> <?php echo $pickupAddress; ?> </p>
									<p class="small hint-text"><b>Phone:</b> <?php echo $jobRecord['shipper_phone']; ?></p>
								</td>
								
                                <td class="text-center"><?php echo (isset($jobRecord['Quantity']) && $jobRecord['Quantity'] != '' ) ? $jobRecord['Quantity'] : '--'; ?></td>
                                <td class="text-center"><?php echo (isset($jobRecord['PickupDate']) && $jobRecord['PickupDate'] != '' && $jobRecord['PickupDate'] != '0000-00-00') ? $jobRecord['PickupDate'] : '--'; ?></td>
                                <td class="text-right"><?php echo (isset($jobRecord['Weight']) && $jobRecord['Weight'] != '' && $jobRecord['Weight'] != '0') ? $jobRecord['Weight'] : '--'; ?></td>
                            </tr>
                            
                            <?php if( !empty($extraStops) && count($extraStops) > 0 ) { 
								foreach( $extraStops as $extraStop ) { ?>
									 <tr>
										<td class="">
											<p class="text-black"><b><?php echo ucfirst($extraStop['extraStopEntity']); ?>:</b> <?php echo $extraStop['extraStopName']; ?></p>
											<p class="small hint-text"><b>Type:</b> <?php echo $jobRecord['LoadType']; ?></p>
											<?php 
												$extraStopAddress = trim($extraStop['extraStopAddress']).', '.$extraStop['extraStopCity'].', '.$extraStop['extraStopState'].', '.$extraStop['extraStopCountry']; 
												$extraStopAddress = trim($extraStopAddress,',');
											?>
											<p class="small hint-text"><b>Address:</b> <?php echo $extraStopAddress; ?> </p>
											<p class="small hint-text"><b>Phone:</b> <?php echo $extraStop['extraStopPhone']; ?></p>
										</td>
										
										<td class="text-center"><?php echo (isset($jobRecord['Quantity']) && $jobRecord['Quantity'] != '' ) ? $jobRecord['Quantity'] : '--'; ?></td>
										<td class="text-center"><?php echo (isset($extraStop['extraStopDate']) && $extraStop['extraStopDate'] != '' && $extraStop['extraStopDate'] != '0000-00-00') ? $extraStop['extraStopDate'] : '--'; ?></td>
										<td class="text-right"><?php echo (isset($jobRecord['Weight']) && $jobRecord['Weight'] != '' && $jobRecord['Weight'] != '0') ? $jobRecord['Weight'] : '--'; ?></td>
									</tr>
							<?php } } ?>
                            ...
                            <tr>
								<td class="">
									...
									<p class="small hint-text"><b>Type:</b> <?php echo $jobRecord['LoadType']; ?></p>
									<?php 
										$destAddress = trim($jobRecord['DestinationAddress']).', '.$jobRecord['DestinationCity'].', '.$jobRecord['DestinationState'].', '.$jobRecord['DestinationCountry']; 
										$destAddress = trim($destAddress,',');
									?>
									<p class="small hint-text"><b>Address:</b> <?php echo $destAddress; ?></p> 
