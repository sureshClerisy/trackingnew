        		...
        		<div class="header">
	        		...
	        		<table class="ttable">
	        			<tr>
	        				...
	        				<td>:</td>
	        				<td class="stext"><?php echo date('M-d-Y', strtotime($args['customDate'])); ?> 12:00 AM <i>to</i> <?php echo date('M-d-Y', strtotime($args['customDate'])); ?> 11:59 PM EST</td>
	        			</tr>
	        			<tr>
                ...
                <table class="top-tab-bar" cellpadding="0" cellspacing="0">
					<thead>
						<tr>
	                      ...
	                      <?php if((is_bool($args['includeLatLong']) && !$args['includeLatLong']) && $args['includeLatLong']== "false" && ($value == 'Latitude' || $value == 'Longitude')){
	                      		 	continue; 
	                      		} ?>
