						...
						<td style="width:300px; ">
							<div style="width:300px; float:right;">
								<div style="float: left;width: 78px;font-size: 13px;">
									<b style="width: 100%;text-transform: uppercase;float: left;font-size: 13px;color: #868686;font-weight: bold;margin-bottom: 10px;">Load ID</b><?php echo $jobDetails['id'];?>
									</div>
						...
						<td style="width:305px; float:left;">
							<div style="padding-left:24px;">
								...
								<div style="width: 100%;float: left;padding-bottom:13px;">
									...
									<span style="float: right;font-size: 13px;color: #000000;"><?php echo (isset($vehicleInfo['label']) && $vehicleInfo['label'] != '' ) ? $vehicleInfo['label'] : ''; ?></span>
								</div>
								<div style="width: 100%;float: left;padding-bottom:13px;">
									...
									<span style="float: right;font-size: 13px;color: #000000;"><?php echo (isset($vehicleInfo['cargo_bay_l']) && $vehicleInfo['cargo_bay_l'] != '' ) ? $vehicleInfo['cargo_bay_l'].' ft' : ''; ?> </span>
								</div>
								<div style="width: 100%;float: left;padding-bottom:13px;">
									...
									<span style="float: right;font-size: 13px;color: #000000;"><?php echo (isset($vehicleInfo['cargo_bay_w']) && $vehicleInfo['cargo_bay_w'] != '' ) ? $vehicleInfo['cargo_bay_w'].' ft' : ''; ?> </span>
								</div>
								<div style="width: 100%;float: left;padding-bottom:13px;">
									...
									<span style="float: right;font-size: 13px;color: #000000;"><?php echo (isset($vehicleInfo['vehicle_type']) && $vehicleInfo['vehicle_type'] != '' ) ? $vehicleInfo['vehicle_type'] : ''; ?>	</span>
								</div>
								<div style="width: 100%;float: left;padding-bottom:15px;">
									...
									<span style="float: right;font-size: 13px;color: #000000;"><?php echo (isset($vehicleInfo['unit_id']) && $vehicleInfo['unit_id'] ) ? $vehicleInfo['unit_id'] : ''; ?></span>
								</div>
								<div style="width: 100%;float: left;padding-bottom:15px;">
									...
									<span style="float: right;font-size: 13px;color: #000000;"><?php echo (isset($vehicleInfo['cargo_capacity']) && $vehicleInfo['cargo_capacity']) ? $vehicleInfo['cargo_capacity'].' LBS' : ''; ?></span>
								</div>
							</div>
						</td>
					</tr>
							...
							<table cellpadding="0" cellspacing="0" style="width:100%; float:left;font-family:arial;border:1px solid #9f9f9f;border-radius:5px;">
								<tr>
									<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;">
										...
										<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['shipper_entity']; ?></p>
									</td>
									<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;">
								...
								<tr>
									<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;border-top:1px solid #9f9f9f;">
										...
										<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['PickupAddress']; ?></p>
									</td>
									<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;border-top:1px solid #9f9f9f;">
										<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">City</b>
										<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['OriginCity']; ?></p>
									</td>
									<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;border-top:1px solid #9f9f9f;">
										<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">State</b>
										<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['OriginState']; ?></p>
									</td>
									<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;border-top:1px solid #9f9f9f;">
										<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">Zip Code</b>
										<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['OriginZip']; ?></p>
									</td>
									<td style="padding: 20px 23px;text-align: left;border-top:1px solid #9f9f9f;">
										...
										<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['OriginCountry']; ?></p>
									</td>
								</tr>
							</table>
						</td>
											...
											<table style="width:100%; float:left;font-family:arial;border:1px solid #9f9f9f;border-radius:5px;" cellspacing="0" cellpadding="0">
												<tbody>
													<tr>
														<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;">
															<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">Entity</b>
															<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['consignee_entity']; ?></p>
														</td>
														<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;">
															<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">Name</b>
															<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['consignee_name']; ?></p>
														</td>
														<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;">
															<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">Telephone</b>
															<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['consignee_phone']; ?></p>
														</td>
														<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;">
															<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">Pickup date</b>
													...
													<tr>
														<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;border-top:1px solid #9f9f9f;">
															<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">Pickup Address</b>
															<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['DestinationAddress']; ?></p>
														</td>
														<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;border-top:1px solid #9f9f9f;">
															<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">City</b>
															<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['DestinationCity']; ?></p>
														</td>
														<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;border-top:1px solid #9f9f9f;">
															<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">State</b>
															<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['DestinationState']; ?></p>
														</td>
														<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;border-top:1px solid #9f9f9f;">
															<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">Zip Code</b>
															<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['DestinationZip']; ?></p>
														</td>
														<td style="padding: 20px 23px;text-align: left;border-top:1px solid #9f9f9f;">
															<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">Counatry</b>
															<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['DestinationCountry']; ?></p>
														</td>
													</tr>
												</tbody>
											</table>
												...
												<tbody>
													<tr>
														...
														<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;">
															...
															<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['equipment_options']; ?></p>
														</td>
														<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;">
													...
													<tr>
														<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;border-top:1px solid #9f9f9f;">
															...
															<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['commodity']; ?></p>
														</td>
														<td style=" padding: 20px 23px;text-align: center;border-right: 1px solid rgb(159, 159, 159);border-top:1px solid #9f9f9f;">
															<div style=" text-align: left; width: 55%; float: left;">
																...
																<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;">$<?php echo $jobDetails['PaymentAmount']; ?></p>
															</div>
															<div style=" text-align: left; width: 25%; float: right;">
																...
																<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['Rate']; ?></p>
															</div>
														</td>
														<td style="text-align: left; border-right: 1px solid rgb(159, 159, 159); padding: 20px 26px;border-top:1px solid #9f9f9f;">
															<div style=" text-align: left; width: 55%; float: left;">
																<b style="font-size:13px;width: 100%;color: #6c6c6c;text-transform: uppercase;float: left;margin-bottom: 13px;">lOAD QUANTITY</b>
																<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['Quantity']; ?></p>
															</div>
															<div style=" text-align: left; width: 30%; float: right;">
																...
																<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['Mileage']; ?></p>
															</div>
														</td>
														<td style="text-align: left;  padding: 20px 26px;border-top:1px solid #9f9f9f;">
															<div style="display: inline-block; text-align: left; width: 51%;">
																...
																<p style="padding: 0px;width: 100%;margin: 0px 0px;float: left;text-transform: uppercase;font-size: 13px;color: #030101;"><?php echo $jobDetails['woRefno']; ?></p>
															</div>
															<div style="display: inline-block; text-align: left; width: 43%;">
